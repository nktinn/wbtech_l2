...
/*
	Паттен "цепочка вызовов" применяется в случаях, когда запрос можно обработать по принципу "сам или передать дальше".
...
обработан или не обработан вообще.
	...
	Примером использования паттерна "цепочка вызовов" может служить обработка запросов веб-сервера. Например, в серсиве
